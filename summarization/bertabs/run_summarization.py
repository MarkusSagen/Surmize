...
def build_data_iterator(args, tokenizer):
    ...
    iterator = DataLoader(dataset, sampler=sampler,
...
def main(rDir, sDir, beam, alpha, minl, maxl):
    ...
    args = argparse.Namespace(alpha=alpha, batch_size=1, beam_size=beam, block_trigram=True, compute_rouge=False,
